...
<@netCommon.commonScript />
    ...
    <#elseif jobInfo.glueType == "GLUE_mesSHELL" >
        <#assign glueTypeModeSrc = "${request.contextPath}/static/plugins/codemirror/mode/messhell/messhell.js" />
        <#assign glueTypeIdeMode = "messhell" />
    </#if>
