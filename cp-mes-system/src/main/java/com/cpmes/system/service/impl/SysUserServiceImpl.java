...
import com.cpmes.common.core.service.UserService;
import com.cpmes.common.exception.ServiceException;
import com.cpmes.common.helper.DataBaseHelper;
...
import com.cpmes.system.domain.*;
import com.cpmes.system.domain.enums.InspectionRecordStatus;
import com.cpmes.system.domain.enums.RepairOrderStatus;
import com.cpmes.system.mapper.*;
...
public class SysUserServiceImpl implements ISysUserService, UserService {
    ...
    public boolean checkUserNameUnique(SysUser user) {
        boolean exist = TenantHelper.ignore(() ->baseMapper.exists(new LambdaQueryWrapper<SysUser>()
     ...
     */
    @Override
    public SysUser selectSuperAdmin(Long userId){
        return TenantHelper.ignore(() -> baseMapper.selectUserById(userId));
    }
